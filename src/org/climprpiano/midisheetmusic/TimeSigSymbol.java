...
public class TimeSigSymbol implements MusicSymbol {
    ...
    public int getMinWidth() { 
        if (candraw) 
            return images[2].getWidth();//TODO * SheetMusic.NoteHeight * 2 /images[2].getHeight();
        else
            return 0;
    }
    ...
    void Draw(Canvas canvas, Paint paint, int ytop) {
        ...
        int imgheight = 0;//TODO SheetMusic.NoteHeight * 2;
        ...
        //TODO dest = new Rect(0, ytop + SheetMusic.NoteHeight*2, imgwidth, ytop + SheetMusic.NoteHeight*2 + imgheight);
